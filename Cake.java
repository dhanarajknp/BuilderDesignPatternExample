...
public class Cake {
    ...
    public Cake(){}
    // public Cake(double sugar, double butter, int eggs, int vanila, double flour, double bakingpowder, double milk,
    //         int cherry) {
    //     this.sugar = sugar;
    //     this.butter = butter;
    //     this.eggs = eggs;
    ...
    public String printCake() { 
        return "Cake{" + "sugar=" + getSugar() + ", butter=" + getCherry() + ", eggs=" + eggs + ", vanila=" + vanila + ", flour="
                + flour + ", bakingpowder=" + bakingpowder + ", milk=" + milk + ", cherry=" + cherry + '}';
    }
}